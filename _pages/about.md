...
**编程能力**  
- 熟练使用 Python，掌握 PyTorch、NumPy、Pandas 等常用深度学习与数据处理工具，能够完成模型搭建、训练调试、数据处理与实验分析。
- 熟悉 Java / Python 后端开发，掌握 Spring Boot、Flask 等开发框架，熟悉 MySQL、Redis 等常用数据存储与中间件，具备完整的服务端开发与调试能力。
